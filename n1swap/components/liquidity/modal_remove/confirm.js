...
class CheckModal extends React.Component {
    ...
    render() {
        ...
        const {steps,token1,token2,active_step,amount} = this.props;
                    ...
                    <Steps direction="vertical" size="small" current={active_step}>
                        {
                            steps.map(one=> {
                                ...
                                }else if (one.get('type') == 'remove_liquidity') {
                                    return <Step title={t('remove liquidity')} description={desc} key={'step'+i}/>
                                }
                            })
                        }
